...
<section className="text-gray-600 body-font bg-gradient-to-r from-blue-500  to-indigo-700">
  <div className="container flex flex-wrap mx-auto w-full px-5 py-6 lg:px-16 items-center">
    <div className="md:pr-12 md:py-8 mb-10 md:mb-0 pb-10">
      ...
      <button className="px-4 py-2 bg-white rounded-lg inline-flex items-center mt-4">Customize Theme
